...
local Events = {
    ...
    CART_SET_QUANTITY_BY_INDEX = "CART_SET_QUANTITY_BY_INDEX",
	...
	CART_SET_QUANTITY_FROM_SHOPPING_LIST = "CART_SET_QUANTITY_FROM_SHOPPING_LIST",
	CART_ADJUST_QUANTITY_BY_INDEX = "CART_ADJUST_QUANTITY_BY_INDEX",
